...
public class Employee {
    ...
    public static List<Employee> employees() {
        return List.of(new Employee(1L, "Rahul Sheth", "+919663374604", BigDecimal.valueOf(15000000)),
                new Employee(2L, "Khushboo Shah", "+918770133516", BigDecimal.valueOf(2500000)),
                new Employee(3L, "Ronak Sheth", "+919738318927", BigDecimal.valueOf(55000)),
                new Employee(4L, "Julie Shah", "+919380585761", BigDecimal.valueOf(7500000)),
                new Employee(5L, "Khushboo Shah", "+919380585762", BigDecimal.valueOf(2500000)));
    }
