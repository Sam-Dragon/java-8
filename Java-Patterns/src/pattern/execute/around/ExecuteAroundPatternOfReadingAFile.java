package pattern.execute.around;
...
public class ExecuteAroundPatternOfReadingAFile {
    ...
    public static void main(String[] args) {
        try {
            BufferredReaderProcessor<BufferedReader, String> function = br -> br.readLine();
    ...
    public static String processFile(BufferredReaderProcessor<BufferedReader, String> functionForReading)
            throws IOException {
...
@FunctionalInterface
interface BufferredReaderProcessor<T, R> {
