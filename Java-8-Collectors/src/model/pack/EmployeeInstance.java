...
public class EmployeeInstance {
    ...
    public EmployeeInstance(Long id, String name, String mobile, BigDecimal salary) {
        super();
        this.id = id;
        this.name = name;
        this.mobile = mobile;
    ...
    public static List<model.pack.EmployeeObj> employees() {
        return List.of(new model.pack.EmployeeObj(1L, "Rahul", "+919663374604", BigDecimal.valueOf(15000000)),
                ...
                new model.pack.EmployeeObj(6L, "Ronak", "+919738318927", BigDecimal.valueOf(230000)),
                new model.pack.EmployeeObj(7L, "Julie", "+919380585761", BigDecimal.valueOf(34000)),
                new model.pack.EmployeeObj(8L, "Khushboo", "+919380585762", BigDecimal.valueOf(56000)));
    }
